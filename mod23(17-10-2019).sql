...
create table pedido(folio int not null auto_increment, impresion varchar(40), desarrollo int, 
 ...
 alter table pedido add column estatus varchar(8);

create table partida(idPar int not null auto_increment, diseno varchar(50), medida varchar(15), piezas int, tipo varchar(40), 
